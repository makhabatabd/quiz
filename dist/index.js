...
if (window.location.pathname.endsWith("/endGame.html")) {
  ...
  var recentUserScore = JSON.parse(localStorage.getItem("recentScore"));
  var username = JSON.parse(localStorage.getItem("usernames"));
  correct.innerText = "Correct: ".concat(recentUserScore.correct);
  incorrect.innerText = "Incorrect: ".concat(recentUserScore.incorrect);
  recentScore.innerText = "Your score ".concat(username, ": ").concat(recentUserScore.score);
}
...
if (window.location.pathname.endsWith("/game.html")) {
  ...
  var decremenT = function decremenT() {
    if (isPause === false) {
      var mindiv = document.querySelector(".mins");
      var secdiv = document.querySelector(".secs");
      mindiv.textContent = Math.floor(seconds / 60);
      secdiv.textContent = seconds % 60 > 9 ? seconds % 60 : "0".concat(seconds % 60);
  ...
  var bell = document.querySelector("#audio");
  var modal__outter = document.querySelector(".modal__outter");
  var restart = document.getElementById("continue");
  var isPause = false;
...
if (window.location.pathname.endsWith("/leaderboard.html")) {
  var attack = function attack() {
    highScoresList.innerHTML = attackScores.map(function (item) {
      return "<li class=\"high-score\">".concat(item.name, " - ").concat(item.score, "</li>");
    }).join("");
  ...
  var practice = function practice() {
    highScoresList.innerHTML = practiceScores.map(function (item) {
      return "<li class=\"high-score\">".concat(item.name, " - ").concat(item.score, "</li>");
    }).join("");
  ...
  var attackScores = JSON.parse(localStorage.getItem("attackScores")) || [];
  var practiceScores = JSON.parse(localStorage.getItem("practiceScores")) || [];
  var btn = document.getElementById("board");
...
if (window.location.pathname.endsWith("/loading.html")) {
  var loaderSeconds = document.querySelector(".game-start span");
  var mode = JSON.parse(localStorage.getItem("mode"));
  var text = document.getElementById("game-start__text");
  var seconds = 2;
...
if (window.location.pathname.endsWith("/game.html") || window.location.pathname.endsWith("/practice.html")) {
  ...
  var calculateNum = function calculateNum() {
    if (levelCounter === 1) {
  ...
  var getRandomEquation = function getRandomEquation() {
    var questionIndex = equations[Math.floor(Math.random() * equations.length)];
    progressText.innerText = "Level ".concat(levelCounter);
    progressBarFull.style.width = "".concat(counter / MAX_SCORE_PER_LEVEL * 100, "%");
  ...
  var divideHelper = function divideHelper() {
    for (var i = 0; i < 200; i++) {
  ...
  var check = function check() {
    if (answer.value == result) {
      ...
      solution.innerHTML = "Correct Answer is ".concat(result, "! Try the next one!");
  ...
  var saveToLocalStorage = function saveToLocalStorage() {
    ...
    if (mode === "practice") {
      ...
      var _exactUser = practiceScores.some(function (item) {
      ...
      if (practiceScores.length > 0) {
        practiceScores.map(function (item) {
      ...
      practiceScores.sort(function (a, b) {
      ...
      exactUser = attackScores.some(function (item) {
        return item.name === username;
      });
      ...
      if (attackScores.length > 0) {
        attackScores.map(function (item) {
          if (item.name === username && item.score < scores) {
            item.score = scores;
          }
        });
      ...
      attackScores.sort(function (a, b) {
        return b.score - a.score;
      });
  ...
  var num_right = document.getElementById("number_right");
  var num_left = document.getElementById("number_left");
  ...
  var animation = document.getElementById("score-animation");
  var score_animation = document.querySelector(".hud__item");
  var modal__outter = document.querySelector(".modal__outter");
  var restart = document.getElementById("continue");
  var menuEnd = document.getElementById("menu-end-game");
  var isPause = false;
  var scores = 0;
  var result;
  var wrong = 0;
  ...
  var incrementScore = function incrementScore(num) {
    scores += num;
    scoreText.innerText = scores;
  };

  var decrementScore = function decrementScore(num) {
    scores -= num;
  ...
  var practiceScores = JSON.parse(localStorage.getItem("practiceScores")) || [];
  var attackScores = JSON.parse(localStorage.getItem("attackScores")) || [];
  var endGame = document.getElementById("game_end");
  var username = JSON.parse(localStorage.getItem("usernames"));
...
if (window.location.pathname.endsWith("/name.html")) {
  var usernameValid = function usernameValid() {
    if (username.value) {
  ...
  var span = document.querySelector(".username__span");
  var lastUsername = JSON.parse(localStorage.getItem("usernames"));
...
if (window.location.pathname.endsWith("/pickGame.html")) {
  var practice = document.querySelector(".practice");
  var time_attack = document.querySelector(".time-attack");
  time_attack.addEventListener("click", function () {
...
// EXTERNAL MODULE: ./src/js/name.js
var js_name = __webpack_require__(1890);
// EXTERNAL MODULE: ./src/js/loading.js
var loading = __webpack_require__(5378);
// EXTERNAL MODULE: ./src/js/logic.js
var logic = __webpack_require__(9770);
// EXTERNAL MODULE: ./src/js/game.js
var game = __webpack_require__(3899);
// EXTERNAL MODULE: ./src/js/endGame.js
var endGame = __webpack_require__(3450);
// EXTERNAL MODULE: ./src/js/pickGame.js
var pickGame = __webpack_require__(7314);
// EXTERNAL MODULE: ./src/js/leaderboard.js
var leaderboard = __webpack_require__(8876);
;// CONCATENATED MODULE: ./src/js/practice.js
